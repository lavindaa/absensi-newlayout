							...
							// menampilkan dalam bentuk html
							 while($row=mysqli_fetch_array($result)) { ?>
							    <tr>
										 ...
										 <td><a href="edit_mahasiswa.php?action_menu=EDIT&id='.$row['nim'].'">Edit</a></td>
										 <td><a href="delete_mahasiswa.php?action_menu=DELETE&id=<?= $row['id'] ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data?');">Hapus</a></td>
									</tr>
							<?php
							}	 
